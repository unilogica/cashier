        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="text-center">
                    <img width="60%" src="{{ \Unilogica\Cashier\Cashier::public_url('/vendor/unilogica-cashier/image/paypal-logo.png') }}" />
                </div>
            </div>
            <div class="col-md-4 mt-40 pd-60">            
                ...
                <script>
                    $(function() {
                        ...
                        var form = jQuery('<form>', {
                            'action': '{{ \Unilogica\Cashier\Cashier::lr_action('\Unilogica\Cashier\Controllers\PaypalController@checkout', [
