    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Unilogica\Cashier\Cashier::public_url('/vendor/unilogica-cashier/image/paystack.svg') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                <form id="paymentForm">
                ...
                <form id="checkoutForm" method="GET" action="{{ \Unilogica\Cashier\Cashier::lr_action('\Unilogica\Cashier\Controllers\PaystackController@paymentRedirect') }}">
