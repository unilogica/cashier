            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($paymentMethod != null)
                    <div class="sub-section">
                        ...
                        <form method="POST" action="{{ action("\Unilogica\Cashier\Controllers\StripeController@checkout", [
                ...
                stripe.confirmCardPayment('{{ $clientSecret }}', {
                    ...
                    if (result.error) {
                        ...
                        if (result.paymentIntent.status === 'succeeded') {
                            ...
                            // copy
                            $.ajax({
                                url: '{{ action("\Unilogica\Cashier\Controllers\StripeController@checkout", [
                                    'invoice_uid' => $invoice->uid,
                                ]) }}',
                                type: 'POST',
                                data: {
