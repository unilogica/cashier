<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ \Unilogica\Cashier\Cashier::public_url('/vendor/unilogica-cashier/css/main.css') }}">
    </head>
    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Unilogica\Cashier\Cashier::public_url('/vendor/unilogica-cashier/image/stripe.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="sub-section">
                    @if ($cardInfo !== NULL)
                        ...
                        <form id="stripe_button"
                            action="{{ \Unilogica\Cashier\Cashier::lr_action('\Unilogica\Cashier\Controllers\StripeController@autoBillingDataUpdate') }}" method="POST">
                            {{ csrf_field() }}
                ...
                <form id="stripe_button" style="display:none"
                    action="{{ \Unilogica\Cashier\Cashier::lr_action('\Unilogica\Cashier\Controllers\StripeController@autoBillingDataUpdate', [
                    '_token' => csrf_token(),
                ]) }}" method="POST">
