    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Unilogica\Cashier\Cashier::public_url('/vendor/unilogica-cashier/image/razorpay.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">                
                ...
                <div class="hide" style="display:none">
                    <form action="{{ \Unilogica\Cashier\Cashier::lr_action('\Unilogica\Cashier\Controllers\RazorpayController@checkout', [
                    '_token' => csrf_token(),
