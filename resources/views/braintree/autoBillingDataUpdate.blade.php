    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Unilogica\Cashier\Cashier::public_url('/vendor/unilogica-cashier/image/braintree.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($cardInfo !== NULL)
                    <div class="sub-section mb-5">
                        ...
                        <form
                            action="{{ \Unilogica\Cashier\Cashier::lr_action('\Unilogica\Cashier\Controllers\BraintreeController@autoBillingDataUpdate') }}" method="POST">
                            {{ csrf_field() }}
